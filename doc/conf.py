...
# -*- coding: utf-8 -*-
#
# YDBposix documentation build configuration file, created by
...
latex_documents = [
    (master_doc, 'YDBposix.tex', u'YDBposix Documentation',
...
man_pages = [
    (master_doc, 'YDBposix', u'YDBposix Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'YDBposix', u'YDBposix Documentation',
     author, 'YDBposix', 'One line description of project.',
     'Miscellaneous'),
]
